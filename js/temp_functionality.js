...
function convertTempBack(){
    var input = document.querySelector("#value2").value;
    var selectVal = document.querySelector('#selectTo').value;
    var selectVal2 = document.querySelector('#selectFrom').value;
